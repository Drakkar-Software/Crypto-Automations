...
PROJECT_NAME = "Crypto-Automations"
AUTHOR = "Drakkar-Software"
VERSION = "0.0.1"  # major.minor.revision => don't forget to also update the setup.py version
...
def _use_module_local_tentacles():
    ...
    if os.getenv("USE_CUSTOM_TENTACLES", "").lower() == "true":
        # do not use crypto_automations/imports tentacles
...
# run this before any other code as only crypto_automations module-local tentacles should be used
_use_module_local_tentacles()

try:
    # import tentacles from crypto_automations/imports directory after "_use_local_tentacles()" call
...
from crypto_automations.automation import *
